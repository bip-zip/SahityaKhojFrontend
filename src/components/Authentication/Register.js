            ...
            <div className='row'>
                ...
                <div className='col  rounded my-5 '>
                   ...
                   <div className="form-floating mb-3">
                        <input type="email"  value={penname} onChange={(e)=>setPenname(e.target.value)} className="form-control" id="floatingInput" placeholder="Your unique id" />
                        <label for="floatingInput">Penname*</label>
                    </div>
                   <div className="form-floating mb-3">
                    ...
                    <div className="form-floating">
                        <input type="password"  value={cpassword} onChange={(e)=>setCpassword(e.target.value)} className="form-control" id="floatingcPassword" placeholder="Confirm Password" />
