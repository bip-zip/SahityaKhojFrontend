...
import AddAwardModal from '../Portfolio/AddAwardModal';

function AddPublicationAward({awards, getInfo}) {
  ...
  const addAwards = (e) => {
    ...
    axios.post("http://localhost:8080/api/publications/add-awards", data, config).then(result => {
...
export default AddPublicationAward