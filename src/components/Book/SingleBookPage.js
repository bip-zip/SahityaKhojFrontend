              ...
              <div className="px-1 py-2">
                ...
                <div className="d-flex justify-content-start align-items-center my-3">
                  ...
                  <div className="d-flex justify-content-start align-items-center me-4">
                    ...
                    <p className="text mb-0">79 reviews</p>
                  </div>
                ...
                <div className="row">
                  <div className="col-md-6 fw-light">
                    <div className="p-1 text-start">
                      ...
                      <p className="text text-dark mb-1">Language: English</p>
                  ...
                  <div className="col-md-6">
                    <div className="p-1 text-start">
                      ...
                      <p className="text text-dark mb-1">Pages: 405</p>
                      <p className="text text-dark mb-1">
                        Price : Rs. {book.price}
                      </p>
                    </div>
